...
namespace InventoryManagementSystem.Repository
{
    ...
    public void AddProduct(string name , string description , int quantity , double price , int inventoryId)
    {
        ...
        Product product = Product.CreateProduct(name , description, quantity , price , inventoryId);
    ...
    public Product FindProductById(int id)
    {
        try
        {
            ...
            var findProduct = _context.Products.Where(item => item.ProductId == id).FirstOrDefault();
            if (findProduct == null)
            {
                throw new ItemNotFoundException("Product not found");
            }
    ...
    {
        return _context.Products.Any(item => item.ProductName == name);
    }
    ...
    {
        return _context.Products.FirstOrDefault(item => item.ProductId == id);
